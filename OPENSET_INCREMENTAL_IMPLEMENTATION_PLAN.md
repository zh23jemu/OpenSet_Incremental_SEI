...
| LoRa 新旧类后端权衡                   | Grouped fusion、训练期类中心锚定、old-logit bias、BN 重校准、新类吸收、dechirped 表示、Stage53 recording 一致性、Stage54 recording CE、Stage55 raw s28 物理域预训练、Stage56 refined filter、Stage57 top80+old-route 和 Stage58 双模型后验路由均未通过最终门槛；Stage 48 原始 I/Q s28 + recording-consensus 将 Overall 提到 `0.2803±0.0148` 并把遗忘降到 `0.1802±0.0185` | 当前正式候选保持 Stage 48；Stage57/58 证明新类吸收、旧类保护和后验路由简单拼接仍是跷跷板，后续停止这类工程小机制，若继续攻只能换更大任务粒度或更强半监督表征重训 |
