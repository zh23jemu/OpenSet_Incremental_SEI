...
- 阶段 3 已新增 WiSig 正式三种子主实验计划、汇总报告脚本和 Slurm 入口，固定 MV-ACC + `ratio_2p0_replay_3p0` 跑 seed 7/13/31，并输出均值/标准差报告。
...
- 提交并跟踪阶段 3 WiSig 正式三种子 Slurm job，完成后同步 `results/stage3/` 运行目录和正式三种子报告。
...
- 阶段 3 WiSig 正式三种子入口已准备，但当前尚未取得 seed 7/13/31 完整运行指标。
