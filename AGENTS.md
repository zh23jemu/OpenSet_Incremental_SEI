...
- Stage 45 下一步推送代码并提交 `stage45_lora_raw_iq_multiwindow_seed7.sbatch`；若 `s14/s28` seed7 任一超过 Stage27 Chirp 的 R3 Overall 且 Old/New 不塌缩，再扩三种子，否则归档为原始 I/Q 多窗负消融。
