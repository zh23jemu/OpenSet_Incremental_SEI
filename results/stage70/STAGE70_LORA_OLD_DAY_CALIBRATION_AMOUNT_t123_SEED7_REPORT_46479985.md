# Stage69 LoRa 旧类 IQ 校准 Seed7 报告（Job 46479985_t123）

## 结论

- 当前判定：未达到 50% 目标，说明真实 IQ_1 旧类校准仍不足以复现 Stage68 oracle 上界。
- Baseline R3 Overall/Old/New = 0.2814/0.2137/0.5524。
- 旧类 IQ 校准 R3 Overall/Old/New = 0.3990/0.3607/0.5524。
...
| old_iq1_calibration | 0.3990 | 0.3607 | 0.5524 | 0.1798 | 0.3616 |
