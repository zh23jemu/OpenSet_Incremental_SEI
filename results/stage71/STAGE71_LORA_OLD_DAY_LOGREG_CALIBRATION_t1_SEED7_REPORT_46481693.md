# Stage69 LoRa 旧类 IQ 校准 Seed7 报告（Job 46481693_t1_logreg）

## 结论

- 当前判定：未达到 50% 目标，说明真实旧类校准仍不足以复现 Stage68 oracle 上界。
- Baseline R3 Overall/Old/New = 0.2814/0.2137/0.5524。
- 旧类 IQ 校准 R3 Overall/Old/New = 0.3643/0.3173/0.5524。
...
| old_iq1_calibration | 0.3643 | 0.3173 | 0.5524 | 0.1964 | 0.3378 |
