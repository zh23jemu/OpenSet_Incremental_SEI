# Stage69 LoRa 旧类 IQ 校准 Seed7 报告（Job 46491367_t123456_logreg_extended）

## 结论

- 当前判定：未达到 50% 目标，说明真实旧类校准仍不足以复现 Stage68 oracle 上界。
- Baseline R3 Overall/Old/New = 0.2814/0.2137/0.5524。
- 旧类 IQ 校准 R3 Overall/Old/New = 0.4619/0.4393/0.5524。
...
| old_iq1_calibration | 0.4619 | 0.4393 | 0.5524 | 0.0893 | 0.4290 |
...
- 旧类校准 transmissions：`1,2,3,4,5,6`
