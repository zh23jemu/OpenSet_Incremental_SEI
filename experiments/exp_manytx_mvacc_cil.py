...
from exp_wisig_mvacc_cil import (
    _expand_closedset_classifier, _update_iq_memory, _train_end_to_end_cil,
    _predict_end_to_end,
)
...
def main():
    ...
    parser.add_argument("--cil_head_warmup_epochs", type=int, default=2)
    parser.add_argument("--cil_joint_epochs", type=int, default=8)
    ...
    clustering_rows, incremental_rows = [], []
    ...
    initial_row = _evaluate_raw_predictions("MV-ACC-CIL", "Initial", eval_data["eval_initial"]["day"], args.initial_known_classes, "day1_eval_initial_30pct", eval_y_dict["eval_initial"], initial_pred, pseudo_to_true, "-", "-", "-", args.initial_known_classes, args.round_size, None)
    ...
    for i, rd in enumerate(round_data, start=1):
        ...
        incremental_rows.append(_evaluate_raw_predictions("MV-ACC-CIL", f"After R{i}", eval_data[eval_key]["day"], args.initial_known_classes + i * args.round_size, f"{eval_key}_30pct_{args.initial_known_classes + i * args.round_size}_seen", eval_y_dict[eval_key], pred, pseudo_to_true, args.round_size, info["discovered_clusters"], len(cluster_ids), args.initial_known_classes, args.round_size, initial_reference_acc))
