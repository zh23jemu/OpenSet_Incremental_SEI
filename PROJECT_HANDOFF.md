...
- 更新时间：2026-07-31
- 当前阶段：Stage 21 ADS-B 三种子已通过；Stage 27 LoRa Chirp backbone 三种子已通过结构门槛，Stage 30/31/32/34/35/36/37 后端候选均已归档为负消融；Stage 38 LoRa 物理域表征预训练 seed7 已通过，等待三种子确认
...
39. Stage 38 seed7 Job `45651503` 已完成：物理域自监督预训练将 R3 Overall/Old/New/Forgetting 从 `0.2552/0.1988/0.4810/0.2786` 提升到 `0.2705/0.2131/0.5000/0.2429`，通过 seed7 门槛；已新增三种子入口。
...
14. Stage 38 下一步跑 seed7/13/31 三种子确认；若三种子均值稳定超过 Stage 27 Chirp 当前候选且 New 不塌缩，再锁定为 LoRa 新候选，否则仅作为 seed7 正信号归档。
