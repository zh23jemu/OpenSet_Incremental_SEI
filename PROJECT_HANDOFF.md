...
- 更新时间：2026-07-31
- 当前阶段：Stage 21 ADS-B 三种子已通过；Stage 27 LoRa Chirp backbone 三种子仍是当前 LoRa 候选；Stage 30/31/32/34/35/36/37/38/39/40 后续候选均未通过正式门槛
...
45. Stage 43 已新增 LoRa recording-level hybrid 三种子验证入口。当前本地和 Slurm 都只发现 LoRa25 紧凑子集，没有完整原始 LoRa 包；因此先验证 Stage 41 中 seed7 局部出现的 recording-level hybrid 收益是否稳定。
...
20. Stage 43 只验证 recording-level 口径，不作为 symbol-level 提升包装；若三种子不过门槛，LoRa 紧凑子集继续攻分应转为下载/处理更大原始数据。
